...
import org.askalon.jlibcloud.compute.driverSpecific.gogrid.GoGridNodeTemplate;
import org.askalon.jlibcloud.compute.driverSpecific.gogrid.GoGridNodeTemplateBuilder;
...
import org.askalon.jlibcloud.compute.wrapperInterfaces.base.NodeLocation;
	...
	public class GoGridNodeTemplateImpl implements GoGridNodeTemplate{

	private final String exIp;
	...
	*/
	private final String type = Providers.GOGRID.name;

	private GoGridNodeTemplateImpl(GoGridNodeTemplateBuilderImpl builder){
		this.exIp = builder.exIp;
	...
	public static NodeTemplateBuilder newBuilder() {
		return new GoGridNodeTemplateBuilderImpl();
	}
	...
	*/
	...
	private static class GoGridNodeTemplateBuilderImpl implements GoGridNodeTemplateBuilder {
		...
		*/
		...
		@Override
		public GoGridNodeTemplateBuilderImpl exIp(String exIp) {
			this.exIp = exIp;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl exDescription(String exDescription) {
			this.exDescription = exDescription;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl keyPair(String keyPair) {
			this.keyPair = keyPair;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl authSshKey(String authSshKey) {
			this.authSshKey = authSshKey;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl imageId(String imageId) {
			this.imageId = imageId;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl location(NodeLocation location) {
			this.location = location;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl authPassword(String authPassword) {
			this.authPassword = authPassword;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl locationId(String locationId) {
			this.locationId = locationId;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl nodeName(String nodeName) {
			this.nodeName = nodeName;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl image(NodeImage image) {
			this.image = image;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl sizeId(String sizeId) {
			this.sizeId = sizeId;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl size(NodeSize size) {
			this.size = size;
			return this;
		}
		...
		/*
		@Override
		public GoGridNodeTemplateBuilderImpl maxTries(int maxTries) {
			this.maxTries = maxTries;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl sshTimeout(float sshTimeout) {
			this.sshTimeout = sshTimeout;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl sshUsername(String sshUsername) {
			this.sshUsername = sshUsername;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl sshKey(String sshKey) {
			this.sshKey = sshKey;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl sshPort(int sshPort) {
			this.sshPort = sshPort;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl sshAlternateUsernames(List<String> sshAlternateUsernames) {
			this.sshAlternateUsernames = sshAlternateUsernames;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl sshInterface(String sshInterface) {
			this.sshInterface = sshInterface;
			return this;
		}

		@Override
		public GoGridNodeTemplateBuilderImpl timeout(int timeout) {
		...
		*/
		...
		public NodeTemplate build() {
			return new GoGridNodeTemplateImpl(this);
		}
	}
}