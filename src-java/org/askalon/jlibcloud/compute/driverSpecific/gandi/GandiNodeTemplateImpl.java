...
import org.askalon.jlibcloud.compute.driverSpecific.gandi.GandiNodeTemplate;
import org.askalon.jlibcloud.compute.driverSpecific.gandi.GandiNodeTemplateBuilder;
...
import org.askalon.jlibcloud.compute.wrapperInterfaces.base.NodeLocation;
	...
	public class GandiNodeTemplateImpl implements GandiNodeTemplate{
	...
	private final Integer inetFamily;
	...
	*/
	private final String type = Providers.GANDI.name;

	private GandiNodeTemplateImpl(GandiNodeTemplateBuilderImpl builder){
	...
	public static NodeTemplateBuilder newBuilder() {
		return new GandiNodeTemplateBuilderImpl();
	}
	...
	*/
	...
	private static class GandiNodeTemplateBuilderImpl implements GandiNodeTemplateBuilder {
		...
		private Integer inetFamily = null;
		...
		*/
		...
		@Override
		public GandiNodeTemplateBuilderImpl keyPair(String keyPair) {
			this.keyPair = keyPair;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl authSshKey(String authSshKey) {
			this.authSshKey = authSshKey;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl location(NodeLocation location) {
			this.location = location;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl authPassword(String authPassword) {
			this.authPassword = authPassword;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl nodeName(String nodeName) {
			this.nodeName = nodeName;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl locationId(String locationId) {
			this.locationId = locationId;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl image(NodeImage image) {
			this.image = image;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl inetFamily(int inetFamily) {
			this.inetFamily = inetFamily;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl password(String password) {
			this.password = password;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl size(NodeSize size) {
			this.size = size;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl imageId(String imageId) {
			this.imageId = imageId;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl name(String name) {
			this.name = name;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl login(String login) {
			this.login = login;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl sizeId(String sizeId) {
			this.sizeId = sizeId;
			return this;
		}
		...
		/*
		@Override
		public GandiNodeTemplateBuilderImpl maxTries(int maxTries) {
			this.maxTries = maxTries;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl sshTimeout(float sshTimeout) {
			this.sshTimeout = sshTimeout;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl sshUsername(String sshUsername) {
			this.sshUsername = sshUsername;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl sshKey(String sshKey) {
			this.sshKey = sshKey;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl sshPort(int sshPort) {
			this.sshPort = sshPort;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl sshAlternateUsernames(List<String> sshAlternateUsernames) {
			this.sshAlternateUsernames = sshAlternateUsernames;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl sshInterface(String sshInterface) {
			this.sshInterface = sshInterface;
			return this;
		}

		@Override
		public GandiNodeTemplateBuilderImpl timeout(int timeout) {
		...
		*/
		...
		public NodeTemplate build() {
			return new GandiNodeTemplateImpl(this);
		}
	}
}