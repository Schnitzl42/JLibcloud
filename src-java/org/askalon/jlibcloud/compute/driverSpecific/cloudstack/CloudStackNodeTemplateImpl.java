...
import org.askalon.jlibcloud.compute.driverSpecific.cloudstack.CloudStackNodeTemplate;
import org.askalon.jlibcloud.compute.driverSpecific.cloudstack.CloudStackNodeTemplateBuilder;
...
import org.askalon.jlibcloud.compute.wrapperInterfaces.base.NodeLocation;
	...
	public class CloudStackNodeTemplateImpl implements CloudStackNodeTemplate{

	private final List<CloudStackNetwork> networks;
	...
	*/
	private final String type = Providers.CLOUDSTACK.name;

	private CloudStackNodeTemplateImpl(CloudStackNodeTemplateBuilderImpl builder){
	...
	public static NodeTemplateBuilder newBuilder() {
		return new CloudStackNodeTemplateBuilderImpl();
	}
	...
	*/
	...
	private static class CloudStackNodeTemplateBuilderImpl implements CloudStackNodeTemplateBuilder {
		private List<CloudStackNetwork> networks = null;
		...
		*/
		...
		@Override
		public CloudStackNodeTemplateBuilderImpl networks(List<CloudStackNetwork> networks) {
			this.networks = networks;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl exUserdata(String exUserdata) {
			this.exUserdata = exUserdata;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl exSecurityGroups(String... exSecurityGroups) {
			this.exSecurityGroups = exSecurityGroups;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl keyPair(String keyPair) {
			this.keyPair = keyPair;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl authSshKey(String authSshKey) {
			this.authSshKey = authSshKey;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl location(NodeLocation location) {
			this.location = location;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl authPassword(String authPassword) {
			this.authPassword = authPassword;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl nodeName(String nodeName) {
			this.nodeName = nodeName;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl locationId(String locationId) {
			this.locationId = locationId;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl image(NodeImage image) {
			this.image = image;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl size(NodeSize size) {
			this.size = size;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl exKeyname(String exKeyname) {
			this.exKeyname = exKeyname;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl imageId(String imageId) {
			this.imageId = imageId;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl sizeId(String sizeId) {
			this.sizeId = sizeId;
			return this;
		}
		...
		/*
		@Override
		public CloudStackNodeTemplateBuilderImpl maxTries(int maxTries) {
			this.maxTries = maxTries;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl sshTimeout(float sshTimeout) {
			this.sshTimeout = sshTimeout;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl sshUsername(String sshUsername) {
			this.sshUsername = sshUsername;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl sshKey(String sshKey) {
			this.sshKey = sshKey;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl sshPort(int sshPort) {
			this.sshPort = sshPort;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl sshAlternateUsernames(List<String> sshAlternateUsernames) {
			this.sshAlternateUsernames = sshAlternateUsernames;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl sshInterface(String sshInterface) {
			this.sshInterface = sshInterface;
			return this;
		}

		@Override
		public CloudStackNodeTemplateBuilderImpl timeout(int timeout) {
		...
		*/
		...
		public NodeTemplate build() {
			return new CloudStackNodeTemplateImpl(this);
		}
	}
}