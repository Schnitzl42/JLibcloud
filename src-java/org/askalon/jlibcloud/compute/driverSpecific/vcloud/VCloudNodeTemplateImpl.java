...
import org.askalon.jlibcloud.compute.driverSpecific.vcloud.VCloudNodeTemplate;
import org.askalon.jlibcloud.compute.driverSpecific.vcloud.VCloudNodeTemplateBuilder;
...
import org.askalon.jlibcloud.compute.wrapperInterfaces.base.NodeLocation;
	...
	public class VCloudNodeTemplateImpl implements VCloudNodeTemplate{

	private final int exCpus;
	...
	*/
	...
	private VCloudNodeTemplateImpl(VCloudNodeTemplateBuilderImpl builder){
	...
	public static NodeTemplateBuilder newBuilder() {
		return new VCloudNodeTemplateBuilderImpl();
	}
	...
	*/
	...
	private static class VCloudNodeTemplateBuilderImpl implements VCloudNodeTemplateBuilder {
		...
		*/
		...
		@Override
		public VCloudNodeTemplateBuilderImpl exCpus(int exCpus) {
			this.exCpus = exCpus;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl keyPair(String keyPair) {
			this.keyPair = keyPair;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl authSshKey(String authSshKey) {
			this.authSshKey = authSshKey;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl location(NodeLocation location) {
			this.location = location;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl authPassword(String authPassword) {
			this.authPassword = authPassword;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl nodeName(String nodeName) {
			this.nodeName = nodeName;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl locationId(String locationId) {
			this.locationId = locationId;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl exVdc(String exVdc) {
			this.exVdc = exVdc;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl image(NodeImage image) {
			this.image = image;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl exNetwork(String exNetwork) {
			this.exNetwork = exNetwork;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl size(NodeSize size) {
			this.size = size;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl imageId(String imageId) {
			this.imageId = imageId;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl exGroup(String exGroup) {
			this.exGroup = exGroup;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl sizeId(String sizeId) {
			this.sizeId = sizeId;
			return this;
		}
		...
		/*
		@Override
		public VCloudNodeTemplateBuilderImpl maxTries(int maxTries) {
			this.maxTries = maxTries;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl sshTimeout(float sshTimeout) {
			this.sshTimeout = sshTimeout;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl sshUsername(String sshUsername) {
			this.sshUsername = sshUsername;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl sshKey(String sshKey) {
			this.sshKey = sshKey;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl sshPort(int sshPort) {
			this.sshPort = sshPort;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl sshAlternateUsernames(List<String> sshAlternateUsernames) {
			this.sshAlternateUsernames = sshAlternateUsernames;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl sshInterface(String sshInterface) {
			this.sshInterface = sshInterface;
			return this;
		}

		@Override
		public VCloudNodeTemplateBuilderImpl timeout(int timeout) {
		...
		*/
		...
		public NodeTemplate build() {
			return new VCloudNodeTemplateImpl(this);
		}
	}
}