...
import java.util.Map;
	...
	public class EC2NodeTemplateImpl implements EC2NodeTemplate{
	...
	private final Integer spotInstances;
	...
	*/
	...
	private EC2NodeTemplateImpl(EC2NodeTemplateBuilderImpl builder){
		...
		this.spotInstances = builder.spotInstances;
	...
	public static NodeTemplateBuilder newBuilder() {
		return new EC2NodeTemplateBuilderImpl();
	}
	...
	*/
	...
	private static class EC2NodeTemplateBuilderImpl implements EC2NodeTemplateBuilder {
		...
		private Integer spotInstances = null;
		//deployment fields
		//deployment isn't yet supported
		/*
		...
		*/
		...
		@Override
		public EC2NodeTemplateBuilderImpl exUserdata(String exUserdata) {
			this.exUserdata = exUserdata;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl exBlockdevicemappings(List<Map<String,Arg>> exBlockdevicemappings) {
			this.exBlockdevicemappings = exBlockdevicemappings;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl exSecurityGroups(String... exSecurityGroups) {
			this.exSecurityGroups = exSecurityGroups;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl keyPair(String keyPair) {
			this.keyPair = keyPair;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl authSshKey(String authSshKey) {
			this.authSshKey = authSshKey;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl location(NodeLocation location) {
			this.location = location;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl authPassword(String authPassword) {
			this.authPassword = authPassword;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl locationId(String locationId) {
			this.locationId = locationId;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl nodeName(String nodeName) {
			this.nodeName = nodeName;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl image(NodeImage image) {
			this.image = image;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl exMincount(int exMincount) {
			this.exMincount = exMincount;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl size(NodeSize size) {
			this.size = size;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl exKeyname(String exKeyname) {
			this.exKeyname = exKeyname;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl imageId(String imageId) {
			this.imageId = imageId;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl exMaxcount(int exMaxcount) {
			this.exMaxcount = exMaxcount;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl exIamprofile(String exIamprofile) {
			this.exIamprofile = exIamprofile;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl exMetadata(Map<String,Arg> exMetadata) {
			this.exMetadata = exMetadata;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl exClienttoken(String exClienttoken) {
			this.exClienttoken = exClienttoken;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl sizeId(String sizeId) {
			this.sizeId = sizeId;
			return this;
		}
		...
		@Override
		public EC2NodeTemplateBuilderImpl maxTries(int maxTries) {
			this.maxTries = maxTries;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl sshTimeout(float sshTimeout) {
			this.sshTimeout = sshTimeout;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl sshUsername(String sshUsername) {
			this.sshUsername = sshUsername;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl sshKey(String sshKey) {
			this.sshKey = sshKey;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl sshPort(int sshPort) {
			this.sshPort = sshPort;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl sshAlternateUsernames(List<String> sshAlternateUsernames) {
			this.sshAlternateUsernames = sshAlternateUsernames;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl sshInterface(String sshInterface) {
			this.sshInterface = sshInterface;
			return this;
		}

		@Override
		public EC2NodeTemplateBuilderImpl timeout(int timeout) {
		...
		*/
		...
		public NodeTemplate build() {
			return new EC2NodeTemplateImpl(this);
		}
