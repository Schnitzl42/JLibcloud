...
import org.askalon.jlibcloud.compute.driverSpecific.opennebula.OpenNebulaNodeTemplate;
import org.askalon.jlibcloud.compute.driverSpecific.opennebula.OpenNebulaNodeTemplateBuilder;
...
import org.askalon.jlibcloud.compute.wrapperInterfaces.base.NodeLocation;
	...
	public class OpenNebulaNodeTemplateImpl implements OpenNebulaNodeTemplate{
	...
	*/
	...
	private OpenNebulaNodeTemplateImpl(OpenNebulaNodeTemplateBuilderImpl builder){
	...
	public static NodeTemplateBuilder newBuilder() {
		return new OpenNebulaNodeTemplateBuilderImpl();
	}
	...
	*/
	...
	private static class OpenNebulaNodeTemplateBuilderImpl implements OpenNebulaNodeTemplateBuilder {
		...
		*/
		...
		@Override
		public OpenNebulaNodeTemplateBuilderImpl networks(List<OpenNebulaNetwork> networks) {
			this.networks = networks;
			return this;
		}

		@Override
		public OpenNebulaNodeTemplateBuilderImpl keyPair(String keyPair) {
			this.keyPair = keyPair;
			return this;
		}

		@Override
		public OpenNebulaNodeTemplateBuilderImpl authSshKey(String authSshKey) {
			this.authSshKey = authSshKey;
			return this;
		}

		@Override
		public OpenNebulaNodeTemplateBuilderImpl imageId(String imageId) {
			this.imageId = imageId;
			return this;
		}

		@Override
		public OpenNebulaNodeTemplateBuilderImpl location(NodeLocation location) {
			this.location = location;
			return this;
		}

		@Override
		public OpenNebulaNodeTemplateBuilderImpl authPassword(String authPassword) {
			this.authPassword = authPassword;
			return this;
		}

		@Override
		public OpenNebulaNodeTemplateBuilderImpl locationId(String locationId) {
			this.locationId = locationId;
			return this;
		}

		@Override
		public OpenNebulaNodeTemplateBuilderImpl nodeName(String nodeName) {
			this.nodeName = nodeName;
			return this;
		}

		@Override
		public OpenNebulaNodeTemplateBuilderImpl image(NodeImage image) {
			this.image = image;
			return this;
		}

		@Override
		public OpenNebulaNodeTemplateBuilderImpl sizeId(String sizeId) {
			this.sizeId = sizeId;
			return this;
		}

		@Override
		public OpenNebulaNodeTemplateBuilderImpl size(NodeSize size) {
			this.size = size;
			return this;
		}
		...
		/*
		@Override
		public OpenNebulaNodeTemplateBuilderImpl maxTries(int maxTries) {
			this.maxTries = maxTries;
			return this;
		}

		@Override
		public OpenNebulaNodeTemplateBuilderImpl sshTimeout(float sshTimeout) {
			this.sshTimeout = sshTimeout;
			return this;
		}

		@Override
		public OpenNebulaNodeTemplateBuilderImpl sshUsername(String sshUsername) {
			this.sshUsername = sshUsername;
			return this;
		}

		@Override
		public OpenNebulaNodeTemplateBuilderImpl sshKey(String sshKey) {
			this.sshKey = sshKey;
			return this;
		}

		@Override
		public OpenNebulaNodeTemplateBuilderImpl sshPort(int sshPort) {
			this.sshPort = sshPort;
			return this;
		}

		@Override
		public OpenNebulaNodeTemplateBuilderImpl sshAlternateUsernames(List<String> sshAlternateUsernames) {
			this.sshAlternateUsernames = sshAlternateUsernames;
			return this;
		}

		@Override
		public OpenNebulaNodeTemplateBuilderImpl sshInterface(String sshInterface) {
			this.sshInterface = sshInterface;
			return this;
		}

		@Override
		public OpenNebulaNodeTemplateBuilderImpl timeout(int timeout) {
		...
		*/
		...
		public NodeTemplate build() {
			return new OpenNebulaNodeTemplateImpl(this);
		}
	}
}